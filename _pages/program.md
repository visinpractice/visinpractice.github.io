...
**SPEAKER**: RJ Andrews, [Info We Trust](http://infowetrust.com) | [@infowetrust](http://twitter.com/infowetrust)
...
**SPEAKER**: Eugene Chen + Joey Cherdarchuk, [Darkhorse Analytics](http://darkhorseanalytics.com) | [@cherdarchuk](http://twitter.com/cherdarchuk) + [@ideaOwl](http://twitter.com/ideaOwl)
...
**SPEAKER**: David Feng, [Tableau](https://tableau.com/) | [@dyfbrain](http://twitter.com/dyfbrain)
...
**SPEAKER**: Frank Hangler, [Plot + Scatter](http://plotandscatter.com/) | [@hangler](http://twitter.com/hangler)
...
**SPEAKER BIO**: Frank Hangler is a designer, developer, and principal at Plot + Scatter, a data communication company specializing in custom-built, web-based visualizations. He has taught and presented on information visualization to business and academic audiences and is an organizer of the Vancouver Data Visualization Meetup. Beyond his visualization work, he is interested in the relationship between society, technology, and design in the digital era, and holds an MSc in the Social Science of the Internet from the Oxford Internet Institute.
...
**SPEAKER**: Callie Neylan, [Microsoft](https://microsoft.com/) | [@neylano](http://twitter.com/neylano)
...
**SPEAKER**: Meghana Venkataswamy + Johanna Fulda, [Clir Renewables](http://clir.eco) | [@jofu_](http://twitter.com/jofu_)
